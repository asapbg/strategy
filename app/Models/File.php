...
//    Code objects
    ...
    const PUBLIC_CONSULTATIONS_OTHER_SOURCE_COMMENTS_UPLOAD_DIR = 'pc' . DIRECTORY_SEPARATOR . 'other-source-comments' . DIRECTORY_SEPARATOR;
    ...
    const ALLOWED_FILE_EXTENSIONS = ['doc', 'docx', 'xsl', 'xlsx', 'pdf', 'jpeg', 'jpg', 'png', 'zip', 'rar'];
    const ALLOWED_FILE_PRIS = ['doc', 'docx', 'xsl', 'xlsx', 'pdf', 'zip', 'rar'];
    const ALLOWED_FILE_STRATEGIC_DOC = ['doc', 'docx', 'pdf'];
    const ALLOWED_FILE_LP_OO = ['doc', 'docx', 'pdf'];

    const ALLOWED_FILE_PAGE = ['doc', 'docx', 'pdf', 'xsl', 'xlsx', 'jpeg', 'jpg', 'png', 'gif', 'apng', 'avif', 'webp', 'zip', 'rar', '7z']; //'image/jpeg', 'image/png', 'image/gif','image/svg+xml', 'image/apng', 'image/avif', 'image/webp'
