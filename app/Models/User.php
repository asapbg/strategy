...
//    use HasApiTokens;
    ...
    const EXCLUDE_CONTACT_USER_BY_MAIL = [
        'r.rankova@government.bg', 'izabelvalcheva@mail.bg', 'file_admin@mail.bg', 'mariq.n.ivanova0809+1@gmail.com',
        'mariq.n.ivanova0809@gmail.com', 'magdalena.mitkova+243@asab.bg', 'mony_koleg@abv.bg'
    ];
