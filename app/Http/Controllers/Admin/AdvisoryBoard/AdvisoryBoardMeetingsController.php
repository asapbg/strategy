...
use App\Http\Requests\UpdateAdvisoryBoardMeetingsRequest;
...
class AdvisoryBoardMeetingsController extends AdminController
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AdvisoryBoardMeeting $advisoryBoardMeetings)
    {
        //
    }
     ...
     *
     * @param \App\Http\Requests\UpdateAdvisoryBoardMeetingsRequest $request
     * @param \App\Models\AdvisoryBoardMeeting                      $advisoryBoardMeetings
     *
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateAdvisoryBoardMeetingsRequest $request, AdvisoryBoardMeeting $advisoryBoardMeetings)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AdvisoryBoardMeeting $advisoryBoardMeetings)
    {
        //
    }
}
