...
//            'consultation_level_id' => ['required', 'numeric', 'exists:consultation_level,id'],
            ...
            'legislative_program_row_id' => ['nullable', 'required_with:legislative_program_id', 'numeric'],
            'operational_program_id' => ['nullable', 'numeric'],
            'operational_program_row_id' => ['nullable', 'required_with:operational_program_id', 'numeric'],
