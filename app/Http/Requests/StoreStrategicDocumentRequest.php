...
class StoreStrategicDocumentRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'strategic_document_level_id' => ['required_without:region_id', 'numeric', 'in:' . implode(',', array_column(InstitutionCategoryLevelEnum::cases(), 'value'))],
            'policy_area_id' => ['nullable', 'numeric', 'exists:field_of_actions,id'],
            'region_id' => ['required_without:strategic_document_type_id', 'nullable', 'numeric', 'exists:regions,id'],
            'strategic_document_type_id' => ['required_without:region_id', 'nullable', 'numeric', 'exists:strategic_document_type,id'],
