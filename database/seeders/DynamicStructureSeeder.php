        ...
        $data = array(
            [
                ...
                'columns' => [
                    ...
                    ['type' => DynamicStructureColumnTypesEnum::TEXT, 'ord' => 2, 'label' => 'Номер на програма'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXT, 'ord' => 3, 'label' => 'Вносител'],
                    ['type' => DynamicStructureColumnTypesEnum::BOOLEAN, 'ord' => 4, 'label' => 'Включен в Плана за действие с мерките, произтичащи от членството на РБ в ЕС'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXT, 'ord' => 5, 'label' => '№ в Плана за действие'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXTAREA, 'ord' => 6, 'label' => 'Цели, основни положения и очаквани резултати'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXTAREA, 'ord' => 7, 'label' => 'Необходими промени в други закони'],
                    ['type' => DynamicStructureColumnTypesEnum::BOOLEAN, 'ord' => 8, 'label' => 'Изготвяне на цялостна оценка на въздействието (да/не)'],
                    ['type' => DynamicStructureColumnTypesEnum::DATE, 'ord' => 9, 'label' => 'Месец на публикуване за обществени консултации'],
                    ['type' => DynamicStructureColumnTypesEnum::DATE, 'ord' => 10, 'label' => 'Месец на изпращане за предварително съгласуване'],
                    ['type' => DynamicStructureColumnTypesEnum::DATE, 'ord' => 11, 'label' => 'Месец на внасяне в Министерския съвет'],
                ]
            ],
            [
                ...
                'columns' => [
                    ...
                    ['type' => DynamicStructureColumnTypesEnum::BOOLEAN, 'ord' => 4, 'label' => 'Включен в Плана за действие с мерките, произтичащи от членството на РБ в ЕС'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXT, 'ord' => 5, 'label' => '№ в Плана за действие'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXTAREA, 'ord' => 6, 'label' => 'Основни положения и очаквани резултати'],
                    ['type' => DynamicStructureColumnTypesEnum::TEXTAREA, 'ord' => 7, 'label' => 'Законово основание за приемане'],
                    ['type' => DynamicStructureColumnTypesEnum::BOOLEAN, 'ord' => 8, 'label' => 'Изготвяне на цялостна оценка на въздействието (да/не)'],
                    ['type' => DynamicStructureColumnTypesEnum::DATE, 'ord' => 9, 'label' => 'Месец на публикуване за обществени консултации'],
                    ['type' => DynamicStructureColumnTypesEnum::DATE, 'ord' => 10, 'label' => 'Месец на изпращане за предварително съгласуване '],
                    ['type' => DynamicStructureColumnTypesEnum::DATE, 'ord' => 11, 'label' => 'Месец на внасяне в Министерския съвет'],
