...
return [
    ...
    */
    ...
    'multicriteria_weight_sum'        => 'Сборът от \'теглата\' трябва да е 100',
    ...
    */
    ...
    'custom' => [
        ...
        'connectIds' => [
            'required_with' => 'Изберете поне един документ',
        ],
        'a' => [
        ...
        'connect_type' => [
            'required_without' => 'Трябва да изберете тип на изменение'
        ],
        'connect_text' => [
            'required_without' => 'Трябва да въведете текст ако не посочите акт'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'file_1'           => 'Оценка на въздействие',
        'file_1_bg'           => 'Оценка на въздействие (BG)',
        'file_1_en'           => 'Оценка на въздействие (EN)',
        'file_2'           => 'Становище на администарцията на Министерски съвет по оценката',
        ...
        'contact_names_bg' => 'Контактна информация (BG)',
        'contact_names_en' => 'Контактна информация (EN)',
        ...
        'evaluation_bg' => 'Самооценка на администрацията (BG)',
        'evaluation_en' => 'Самооценка на администрацията (EN)',
        'evaluation_status_bg' => 'Самооценка на администрацията (статус) (BG)',
        'evaluation_status_en' => 'Самооценка на администрацията (статус) (EN)',
        ...
        'operational_program_row_id' => 'Проект на нормативен акт от оперативната програма'
    ],
];
