...
return [
    ...
    'registration_disabled' => 'Извършваме подобрения в регистрационната система на Портала за обществени консултации, затова в временно сме преустановили възможностите за регистрация в системата.<br>Благодарим ви за разбирането!',
