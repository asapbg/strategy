...
return [
    ...
    'sort_info_strategic_documents' => '<p class="mb-1"><strong>Категория</strong> - сортира записите по категория в азбучен ред (низходящо и възходящо)</p>
    <p class="mb-1"><strong>Област на политика</strong> - сортира записите по Област на политика в азбучен ред (низходящо и възходящо)</p>
    <p class="mb-1"><strong>Заглавие </strong> - сортира записите по заглавие в азбучен ред (низходящо и възходящо)</p>
