...
//    Route::get('/institution-profile/strategic-documents/{item}', 'institutionStrategicDocuments')->name('institution.profile.sd');
    ...
    Route::controller(\App\Http\Controllers\PublicConsultationController::class)->group(function () {
        ...
        Route::get('/public-consultations/reports/field-of-actions','fieldOfActionsReport')->name('public_consultation.report.field_of_actions');
        Route::get('/public-consultations/reports/field-of-actions-institution', 'fieldOfActionsInstitutionReport')->name('public_consultation.report.field_of_actions.institution');
