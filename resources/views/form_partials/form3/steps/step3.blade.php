<h3>5. Анализ на въздействията</h3>

<h4>5.1. Определяне на икономическите, социални и екологични въздействия</h4>
...
<thead>
    <tr>
        <td></td>
        <td>{{ __('forms.economic_impacts') }}</td>
        <td>{{ __('forms.social_impact') }}</td>
        <td>{{ __('forms.ecologic_impact') }}</td>
        <td>{{ __('forms.specific_impact') . ' 1' }}</td>
        <td>{{ __('forms.specific_impact') . ' 2' }}</td>
    </tr>
</thead>
...
<h4>5.2. Качествена оценка на по-значимите въздействия и специфичните им аспекти</h4>
