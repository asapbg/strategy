...
@for($n=0; $n<$loop; $n++)
    <div class="row @if($n) mt-4 @endif">
        <div class="col-sm-12">
            <h5>{{ isset($point) ? $point : '1.3' }}.{{ $n+1 }}. {{ __('custom.forms.to_problem') }} {{ $n+1 }}:</h5>
        </div>
    </div>
    ...
    @for($m=0; $m<$loop2; $m++)
        <div class="row @if($m > 0) mt-5 @endif">
            <div class="col-sm-12">
                ...
                {!! __('custom.forms.variant.description') !!}
            </div>
        {{--</div>--}}
        {{--<div class="row">--}}
            <div class="col-sm-12">
                ...
                <p><i>{{ __('custom.forms.variant.to_all_groups') }}</i></p>
                ...
                <h6>{{ __('custom.forms.specific_impact') }}:</h6>
