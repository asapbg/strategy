...
<div class="row">
    ...
    <div class="row sort-row fw-600 main-color-light-bgr align-items-center rounded py-2 px-2 m-0">
        <div class="col-md-3">
            <p class="mb-0 cursor-pointer d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-sort me-2"></i>
                <a href="#" class="mb-0 text-decoration-none text-dark ajaxSort ">Област на политика</a>
            </p>
        </div>
        <div class="col-md-2 cursor-pointer ">
            <p class="mb-0 cursor-pointer d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-sort me-2"></i>
                <a href="#" class="mb-0 text-decoration-none text-dark ajaxSort ">Вид орган</a>
            </p>
        </div>
        ...
        <div class="col-md-2">
            <p class="mb-0 cursor-pointer d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-sort me-2"></i>
                <a href="#" class="mb-0 text-decoration-none text-dark ajaxSort ">Акт на създаване</a>
            </p>
        </div>
        <div class="col-md-2">
            <p class="mb-0 cursor-pointer d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-sort me-2"></i>
                <a href="#" class="mb-0 text-decoration-none text-dark ajaxSort ">Вид председател</a>
            </p>
        </div>
        <div class="col-md-3">
            <p class="mb-0 cursor-pointer d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-sort me-2"></i>
                <a href="#" class="mb-0 text-decoration-none text-dark ajaxSort ">Представител НПО</a>
            </p>
        </div>
    </div>
    <div class="row justify-content-start mt-3 group-paginate">
        <div
            class="col-md-5 mb-3 text-start col-sm-12 d-flex align-items-center justify-content-start flex-direction-row">
            <label for="groupBy" class="form-label fw-bold mb-0 me-3 no-wrap group-by-label">Групиране по:</label>
            <select class="form-select w-100" id="groupBy" name="groupBy">
                <option value="">Област на политика</option>
                <option value="">Вид орган</option>
                <option>Вид председател на консултативен съвет</option>
                <option value="">Наличие на представител на НПО в състава на съвета</option>
                <option value="">Статус</option>
                <option value="">Акт на създаване</option>
            </select>
        </div>
