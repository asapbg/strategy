...
<div id="initiatives_pagination" class="ajax_pagination row mb-4" data-id="initiatives" @if(!($initiatives->count() > \App\Models\LegislativeInitiative::HOME_PAGINATE)) style="margin-top: 75px;" @endif>
    @desktop
