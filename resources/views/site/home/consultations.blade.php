...
<div id="consultations_pagination" class="ajax_pagination row mb-4" data-id="consultations" @if(!($initiatives->count() > \App\Models\Consultations\PublicConsultation::HOME_PAGINATE)) style="margin-top: 125px;" @endif>
    @desktop
