                                ...
                                <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                                    ...
                                    <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 mb-2">
                                        <ul class="list-unstyled ps-3">
                                            ...
                                            <hr class="custom-hr">
                                            <li class="my-2"><a href="#" class="text-white active-item-left p-1  text-decoration-none">Оперативна програма</a></li>
                                            <hr class="custom-hr">
                                        </ul>
                                    </ul>
                            ...
                            <div class="consul-wrapper">
                                <div class="single-consultation d-flex">
                                    <div class="consult-body">
                                        <a href="{{ route('op.view', ['id' => $item->id]) }}" class="consul-item">
                                            <p>
