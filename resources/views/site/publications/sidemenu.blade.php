                ...
                <li class="mb-1">
                    ...
                    <div class="collapse show mt-3" id="home-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                            <li class="mb-2 p-1 @if(request()->routeIs('library.news') || $type == App\Enums\PublicationTypesEnum::TYPE_NEWS) active-item-left @endif">
                                <a href="{{ route('library.news') }}" class="link-dark text-decoration-none">Новини</a>
                            </li>
                            <li class="mb-2 p-1 @if(request()->routeIs('library.publications') || $type == App\Enums\PublicationTypesEnum::TYPE_LIBRARY) active-item-left @endif">
