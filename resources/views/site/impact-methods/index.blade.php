        ...
        <div class="col-lg-10  home-results home-results-two pris-list mt-5 mb-5">
            <div class="custom-card py-4 px-3 mb-5">
                <div class="col-md-12">
                    ...
                    <p>
                        При оценката на въздействието задължително се изчислява административният товар. (
                        <a href="">виж Формулярите</a>
                        ). Административният товар са разходите, наложени върху бизнеса, когато се спазват
                        информационните задължения, произлизащи от правителствена разпоредба. Използвайте този
                        калкулатор, за да оцените административния товар за всяка опция, която се разглежда в оценката
                        на въздействието.
                    </p>
                    <p>За повече информация виж: <a href="">Как да оценяваме разходите?</a></p>
                </div>
            </div>
