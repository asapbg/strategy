...
{{--                                                            role="button" title="{{ __('custom.edit') }}"></i>--}}
{{--                                                    </a>--}}
{{--                                                    @endcan--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                                    <i class="far fa-calendar text-secondary me-1" title="Период"></i>--}}
{{--                                                    <!----}}
...
{{--                                                <a href="{{ route( 'strategy-document.view' , [$document->id]) }}">--}}
{{--                                                    {{ $document->title }}--}}
{{--                                                    {{ $document->document_date_accepted ? \Carbon\Carbon::parse($document->document_date_accepted)->format('Y') : '' }}--}}
{{--                                                    ---}}
{{--                                                    {{ $document->document_date_expiring ? \Carbon\Carbon::parse($document->document_date_expiring)->format('Y') : 'Безсрочен' }}--}}
{{--                                                </a>--}}
{{--                                            </span>--}}
{{--                                        </li>--}}
{{--                                        @endforeach--}}
...
{{--                                @php--}}
{{--                                $categoryName = $key == 'district-level' ? trans_choice('custom.area_level', 1) :--}}
{{--                                trans_choice('custom.distrinct_level', 1);--}}
{{--                                @endphp--}}
{{--                                <li class="parent_li">--}}
{{--                                    <span>--}}
{{--                                        <a href="#" class="main-color fs-18" data-toggle="collapse"--}}
...
{{--'file_change_warning_txt' => __('custom.are_you_sure_to_delete') . ' ' .--}}
{{--Str::lower(trans_choice('custom.strategic_documents', 1)) . '?',--}}
{{--])--}}
@endsection
