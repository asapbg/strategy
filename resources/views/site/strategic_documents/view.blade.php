                        ...
                        <div class="fs-18">
                            @if ($strategicDocument->pris?->doc_num && $strategicDocument->pris?->published_at)
                                ...
                                <a href="{{ $route }}" class="main-color text-decoration-none">
                                    {{ $strategicDocument->pris?->actType?->name_single . ' №/' . $strategicDocument->pris?->doc_num . '/' . $strategicDocument->pris?->doc_date }}
                                </a>
                            @else
                                <a href="{{ $strategicDocument->strategic_act_link }}" class="main-color text-decoration-none">
                                    ...
                                    @if ($strategicDocument->document_date)
                                        от дата <span>{{ displayDate($strategicDocument->document_date) }}</span>
                                    @endif
                                ...
                                <ul class="list-group list-group-flush">
                                    @foreach ($strategicDocumentFiles as $f)
                                        <li class="list-group-item">
                                            @if(is_android() && $f->content_type == 'application/pdf')
                                                @php
