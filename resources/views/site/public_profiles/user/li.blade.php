...
{{--                        Like Profile Layout--}}
                            ...
                            <div class="row @if(!$loop->last) mb-4 @endif">
                                <div class="col-md-8">
                                    ...
                                    {{ __('custom.end_after') }}: {{ $row->endAfterDays.' '.trans_choice('custom.days', $row->endAfterDays) }}
                                </span>
                                        @else
                                ...
                                <i class="far fa-thumbs-up text-secondary"></i> {{ $row->countLikes() }}
                            </span>
                                        <span class="ms-2 mb-2 text-secondary">
                                <i class="far fa-thumbs-up text-secondary"></i> {{ $row->countDislikes() }}
                            </span>
                                    </div>
                                </div>
                                <div class="col-md-4">
...
{{--                    Like Legislative iniciative List Layout--}}
{{--                        <div class="row mb-4">--}}
{{--                            <div class="col-md-12">--}}
