                                        ...
                                        <div class="consul-item">
                                            ...
                                            <div class="consult-item-header d-flex justify-content-between">
                                                <div class="consult-item-header-link">
                                                    <a href="{{ route('public_consultation.view', ['id' => $consultation->id]) }}"
                                                       class="text-decoration-none" title="{{ $consultation->title }}">
                                            ...
                                            <div class="meta-consul mb-2">
                                                <span class="text-secondary d-flex flex-row align-items-center lh-normal">
                                                    <i class="fas fa-hashtag text-secondary me-1" title="{{ __('custom.period') }}"></i>
                                            ...
                                            <div class="meta-consul mb-2">
                                                <span class="text-secondary d-flex flex-row align-items-baseline lh-normal">
                                                    <i class="far fa-calendar text-secondary me-1" title="{{ __('custom.period') }}">
                                                    </i> {{ displayDate($consultation->open_from) }} -
                                                    {{ displayDate($consultation->open_to) }}
                                                </span>
                                            </div>
                                                ...
                                                <div class="meta-consul justify-content-start">
                                                    @if($consultation->actType)
                                                        <span class="me-2 mb-2">
                                                            ...
                                                            <a class="act-type act-type-{{ $consultation->act_type_id }}" target="_blank"
                                                               href="{{ route('public_consultation.index').'?actType='.$consultation->act_type_id }}"
                                                            >
                                                                {{ $consultation->actType->name }}
                                                            </a>
                                                        </span>
                                                    @endif
                                                    @if($consultation->actType && $consultation->consultation_level_id)
                                                    ...
                                                    @if($consultation->consultation_level_id)
                                                        <span class="ms-2 mb-2">
                                                            ...
                                                            <a class="institution-level level-{{ strtolower(\App\Enums\InstitutionCategoryLevelEnum::keyByValue($consultation->consultation_level_id)) }}"
                                                               target="_blank"
                                                               href="{{ route('public_consultation.index').'?level='.$consultation->consultation_level_id }}"
                                                            >
                                                                {{ __('custom.nomenclature_level.'.\App\Enums\InstitutionCategoryLevelEnum::keyByValue($consultation->consultation_level_id)) }}
                                                            </a>
                                                        </span>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="meta-consul">
                                                <span>
                                                    ...
                                                    <span
                                                        class="{{ $consultation->inPeriodBoolean ? 'active' : 'inactive' }}-ks">{{ $consultation->inPeriod }}</span>
                                                </span>
                                                <a href="{{ route('public_consultation.view', ['id' => $consultation->id]) }}"
                                                   title="{{ $consultation->title }}" class="mt-2"
                                                >
                                                    <i class="fas fa-arrow-right read-more text-end"></i>
                                                    <span class="d-none">{{ $consultation->title }}</span>
                                                </a>
                                            </div>
