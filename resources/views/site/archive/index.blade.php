                            ...
                            <div class="collapse show mt-3" id="home-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                                    <li class="mb-2  p-1"><a href="#"
                                                             class="link-dark text-decoration-none">Планиране</a>
                                    </li>
                                    ...
                                    <li class="mb-2 active-item-left p-1">
                                        <a href="#" class="link-dark text-decoration-none">Актове на МС</a>
                                    </li>
                                    ...
                                    <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1">
                                        <ul class="list-unstyled ps-3">
                                            <hr class="custom-hr">
                                            <li class="my-2"><a href="#"
                                                                class="link-dark  text-decoration-none">Постановления</a>
                                            </li>
                                            <hr class="custom-hr">
                                            <li class="my-2"><a href="#"
                                                                class="link-dark  text-decoration-none">Решения</a>
                                            </li>
                                            <hr class="custom-hr">
                                            <li class="my-2"><a href="#"
                                                                class="link-dark  text-decoration-none">Становища</a>
                                            </li>
                                            <hr class="custom-hr">
                                            <li class="my-2"><a href="#"
                                                                class="link-dark  text-decoration-none">Протоколи</a>
                                            </li>
                                            <hr class="custom-hr">
                                        </ul>
                                    </ul>
                        ...
                        <div class="single-consultation d-flex">
                            <div class="consult-body">
                                <div class="consul-item">
                                    ...
                                    <a href="#" class="text-decoration-none"><i class="fas fa-sitemap me-2 main-color"
                                                                                title="Категория">
                                            <span class="fw-normal main-color"> Решения</span></i>
                                    </a>
                                    <a href="#" class="text-decoration-none"><i class="fas fa-university fa-link main-color"
                                                                                title="Протокол"></i>
                                        <span class="fw-normal main-color"> МС</span>
                                    </a>
                                    <div class="anotation text-secondary mb-2 mt-2">
                                        <span class="main-color me-2">Относно:</span> Проект на Решение за одобряване проект
                                        на
