                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabsContent">
                            <div class="tab-pane fade active show" id="ct-general" role="tabpanel" aria-labelledby="ct-general-tab">
                                <form action="http://strategy.test/admin/publications/store/1" method="post" name="form" id="form" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane fade" id="ct-files" role="tabpanel" aria-labelledby="ct-files-tab">
                                <form action="http://strategy.test/admin/upload-file/1/1" method="post" name="form" id="form" enctype="multipart/form-data">
