                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabsContent">
                            <div class="tab-pane fade active show" id="ct-general" role="tabpanel" aria-labelledby="ct-general-tab">
                                <form action="https://strategy.asapbg.com/admin/publications/store/1" method="post" name="form" id="form" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="cRfo412J0ivy5hyr60L1bZhWzOX2p7jYuPiq4nBb">                                                                    <input type="hidden" name="_method" value="PUT">                                    <input type="hidden" name="type" value="1">
                                    ...
                                    <div class="row mb-4">
                                            ...
                                            <div class="col-md-2 col-12">
                                                <div class="form-group">
                                                    <label class="control-label" for="active">
                                                        Тип:  <span>Библиотека</span>                                                </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <input name="slug" value="dsgfsdg" class="form-control form-control-sm ">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="short_content_bg" name="short_content_bg"
                                                          class="form-control form-control-sm ">fgdfg</textarea>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="short_content_en" name="short_content_en"
                                                          class="form-control form-control-sm ">dfgdfg</textarea>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="content_bg" name="content_bg"
                                                          class="form-control form-control-sm summernote ">&lt;p&gt;dfgdfg&lt;/p&gt;</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <input type="text" name="published_at" value="2023-10-13 00:00:00" class="datepicker form-control form-control-sm ">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-12">
                            ...
                            <div class="tab-pane fade" id="ct-files" role="tabpanel" aria-labelledby="ct-files-tab">
                                <form action="https://strategy.asapbg.com/admin/upload-file/1/1" method="post" name="form" id="form" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="cRfo412J0ivy5hyr60L1bZhWzOX2p7jYuPiq4nBb">                                    <div class="mb-3">
                                        <label for="description" class="form-label">Публично име <span class="required">*</span> </label>
                                        <input value="" class="form-control form-control-sm " id="description" type="text" name="description">
                                    </div>
                                    <div class="mb-3">
