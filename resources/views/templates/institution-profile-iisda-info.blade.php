    ...
    <div class="col-lg-10 right-side-content py-5 ">
        ...
        <div class="row pris-row pb-2 mb-2">
            ...
            <div class="col-md-9 pris-left-column"><a href="#"><span class="pris-tag">
                        М-во на финансите</span></a> <a href="#"><span class="pris-tag">Възстановяване</span></a> <a href="#"><span class="pris-tag">Финансови средства</span></a>
            </div>
        </div>
        ...
        <div class="row pris-row pb-2 mb-2">
            ...
            <div class="col-md-9 pris-left-column">
                <a href="#" class="main-color"></a><a href="http://strategy.test/templates/pris-postanovlenie" target="_blank" class="text-decoration-none">Постановление №496 на Министерския съвет от 2022 г.</a>
            </div>
        </div>
