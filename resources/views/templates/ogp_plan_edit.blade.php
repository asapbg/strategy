    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>OGP (редакция на План за действие)</h1>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="active">Област</label>
                                            <select class="form-control form-control-sm">
                                                <option>ДОСТЪП ДО ИНФОРМАЦИЯ</option>
                                                <option>ОТВОРЕНИ ГРАДОВЕ</option>
                                                <option>ПОЧТЕНО УПРАВЛЕНИЕ (ИНТЕГРИТЕТ)</option>
                                                <option>ОТВОРЕНИ ДАННИ</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="active">Заглавие</label>
                                            <textarea class="form-control form-control-sm"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="active">Съдържание/Въведение</label>
                            ...
                            <div class="tab-pane fade" id="ct-files" role="tabpanel" aria-labelledby="ct-files-tab">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-5">
                                        <div class="form-group">
                                            <label class="control-label bg-primary px-4 w-100 rounded-1" for="active">Мярка #1</label>
                                            <textarea class="form-control summernote"></textarea>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-5">
                                        <div class="form-group">
                                            <label class="control-label bg-primary px-4 w-100 rounded-1" for="active">Мярка #2</label>
                                            <textarea class="form-control summernote"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="active">Съдържание</label>
                                    ...
                                    <div class="col-md-6 mb-5">
                                        <div class="form-group">
                                            <label class="control-label bg-primary px-4 w-100 rounded-1" for="active">Мярка #3</label>
                                            <textarea class="form-control summernote"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="active">Съдържание</label>
