                        ...
                        <div class="collapse show mt-3" id="home-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                                ...
                                <li class="mb-2  active-item-left p-1"><a href="#"
                                        class="link-dark text-decoration-none">Данни за институцията в ИИСДА</a>
                                </li>
                                <li class="mb-2"><a href="#" class="link-dark text-decoration-none">Обществени консултации</a>
                                </li>
                                <li class="mb-2"><a href="#" class="link-dark text-decoration-none">Стратегически документи</a>
                                </li>
                                <li class="mb-2"><a href="#" class="link-dark text-decoration-none">Законодателни програми</a>
                                </li>
