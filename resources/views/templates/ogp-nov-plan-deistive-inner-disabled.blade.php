        ...
        <div class="row mt-2 mb-3 align-items-center">
            <div class="col-md-8">
                <a href="#" class="text-decoration-none">
                    <span class="obj-icon-info me-2 text-secondary">
                        <span class="closed-li me-2">Нективен</span>
                        <i class="far fa-calendar me-1 text-secondary" title="Дата на публикуване"></i>04.07.2022 г. -
                        31.12.2022 г.
                    </span>
                </a>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group ">
                                <div class="mb-3 d-flex flex-column  w-100">
                                    ...
                                    <select class="form-select" id="regulatory-act" disabled>
                            ...
                            <div class="input-group ">
                                <div class="mb-3 d-flex flex-column w-100">
                                    ...
                                    <div class="summernote-wrapper">
                                        <textarea  name="suggestion" id="add-sugestion" disabled class="w-100"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
