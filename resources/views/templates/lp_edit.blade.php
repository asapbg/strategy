        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form class="row" action="https://strategy.asapbg.com/admin/consultations/legislative_programs/store?item=1" method="post" name="form" id="form" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                <table class="table table-sm table-responsive sm-text  table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="https://strategy.asapbg.com/admin/consultations/legislative_programs/remove-row/1/2"><i class="fas fa-trash text-danger"></i></a>
                                        </td>
                                        <td>1</td>
                                        <td>
