...
<head>
    ...
    <title>Strategy :: Динамични структури</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> Редакция на Динамична структура</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                Редакция на Динамична структура
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    <div class="card-header">Законодателна програма</div>
                    <div class="card-body">
                        <form class="row mb-4" action="https://strategy.asapbg.com/admin/dynamic-structures/add-column" method="post">
                            <input type="hidden" name="_token" value="cRfo412J0ivy5hyr60L1bZhWzOX2p7jYuPiq4nBb">                            <input type="hidden" name="_method" value="POST">                            <input type="hidden" name="id" value="1">
                            <input type="hidden" name="row_id" value="0">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="label_bg">Наименование (BG) <span class="required">*</span> </label>
                                    <div>
                                        <input name="label_bg" value="" class="form-control form-control-sm " type="text" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="label_en">Наименование (EN) <span class="required">*</span> </label>
                                    <div>
                                        <input name="label_en" value="" class="form-control form-control-sm " type="text" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="type">Тип <span class="required">*</span> </label>
                        ...
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th class="text-center" colspan="4">Колони</th>
                            </tr>
                            <tr>
                                <th>ID</th>
                                <th>Тип</th>
                            ...
                            <tr>
                                <td>1</td>
                                <td>text</td>
                                <td>Наименование на законопроекта</td>
                                <td>Наименование на законопроекта</td>
                            </tr>
                            <tr>
                                <td>2</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>text</td>
                                <td>Включен в Плана за действие с мерките, произтичащи от членството на РБ в ЕС (№ в плана/не)</td>
                                <td>Включен в Плана за действие с мерките, произтичащи от членството на РБ в ЕС (№ в плана/не)</td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>text</td>
                                <td>Цели, основни положения и очаквани резултати</td>
                                <td>Цели, основни положения и очаквани резултати</td>
                            </tr>
                            <tr>
                                <td>5</td>
                                <td>text</td>
                                <td>Необходими промени в други закони</td>
                                <td>Необходими промени в други закони</td>
                            </tr>
                            <tr>
                                <td>6</td>
                                <td>text</td>
                                <td>Изготвяне на цялостна оценка на въздействието (да/не)</td>
                                <td>Изготвяне на цялостна оценка на въздействието (да/не)</td>
                            </tr>
                            <tr>
                                <td>7</td>
                                <td>text</td>
                                <td>Месец на публикуване за обществени консултации</td>
                                <td>Месец на публикуване за обществени консултации</td>
                            </tr>
                            <tr>
                                <td>8</td>
                            ...
                            <tr>
                                <td>9</td>
                                <td>text</td>
                                <td>Месец на внасяне в Министерския съвет</td>
                                <td>Месец на внасяне в Министерския съвет</td>
                            </tr>
                            <tr>
                                <td>20</td>
                                <td>number</td>
                                <td>полседна законодателни</td>
                                <td>полседна законодателни</td>
                            </tr>
                            <tr>
                                <td>21</td>
