                        ...
                        <div class="single-consultation d-flex">
                            <div class="consult-body">
                                <a href="#" class="consul-item">
                                    ...
                                    <p>
                                        <i class="fas fa-sitemap me-2 main-color" title="Категория"><span class="fw-normal main-color"> Решения</span></i>
                                        <i class="fas fa-university fa-link main-color" title="Протокол"></i><span class="fw-normal main-color"> МС</span>
                                    </p>
                                    <div class="anotation text-secondary mb-2">
                                        <span class="main-color me-2">Относно:</span> Проект на Решение за одобряване проект на Споразумение относно Централноевропейската програма за обмен в университетското образование (CEEPUS IV)
                                    </div>
                        ...
                        <div class="single-consultation d-flex">
                            <div class="consult-body">
                                <a href="#" class="consul-item">
                                    ...
                                    <p>
                                        <i class="fas fa-sitemap me-2 main-color" title="Категория"><span class="fw-normal main-color"> Постановления</span></i>
                                        <i class="fas fa-university fa-link main-color" title="Протокол"></i><span class="fw-normal main-color"> МС</span>
                                    </p>
                                    <div class="anotation text-secondary mb-2">
                                        <span class="main-colore me-2">Относно:</span> За прекратяване на ликвидацията и за продължаване на дейността на еднолично акционерно дружество с държавно участие в капитала "България Хепи Мед Сървиз" ЕАД
                                    </div>
                                    <div class="meta-consul">
                        ...
                        <div class="single-consultation d-flex">
                            <div class="consult-body">
                                <a href="#" class="consul-item">
                                    ...
                                    <p>
                                        <i class="fas fa-sitemap me-2 main-color" title="Категория"><span class="fw-normal main-color"> Протоколи</span></i>
                                        <i class="fas fa-university fa-link main-color" title="Протокол"></i><span class="fw-normal main-color"> МС</span>
                                    </p>
                                    <div class="anotation text-secondary mb-2">
                                        <span class="main-color me-2">Относно:</span> Протокол за заседание на МС проведено на 23.08.2023
                                    </div>
                                    <div class="meta-consul">
