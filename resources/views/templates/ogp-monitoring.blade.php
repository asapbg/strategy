            ...
            <div class="col-md-12">
                <div class="input-group ">
                    <div class="mb-3 d-flex flex-column  w-100">
                        <label for="exampleFormControlInput1" class="form-label">Вид доклад</label>
                        <select class="form-select select2" multiple aria-label="Default select example">
                            <option value="1">Всички</option>
                            <option value="1">Самооценка на администрацията по действащи планове за действие</option>
                            <option value="1">Доклади на независим оценител по изпълнението на плана.</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="input-group ">
                    <div class="mb-3 d-flex flex-column  w-100">
                        ...
                        <select class="form-select select2" multiple aria-label="Default select example">
                            <option value="1">Всички</option>
                            <option value="1">Незапочнало изпълнение</option>
                            <option value="1">Ограничено изпълнение</option>
        ...
        <div class="row sort-row fw-600 main-color-light-bgr align-items-center rounded py-2 px-2 m-0">
            <div class="col-md-3">
                <a href="https://strategy.asapbg.com/strategy-documents?order_by=policy-area"
                    ...
                    <i class="fa-solid fa-sort me-2 "></i>Вид доклад
                </a>
            </div>
                ...
                <div class="consul-wrapper">
                    <div class="single-consultation d-flex">
                        <div class="consult-img-holder p-2">
                            <i class="bi bi-clipboard-check main-color"></i>
                        </div>
                            ...
                            <div href="#" class="consul-item">
                                <div class="consult-item-header d-flex justify-content-between">
                                    <div class="consult-item-header-link">
                                        <a href="#" class="text-decoration-none" title="Национални програми за развитие на образованието за 2023 г.">
                                            <h3>Наименование на доклад за Оценка за изпълнението на плановете за действие - мониторинг</h3>
                                        </a>
                                    </div>
                                ...
                                <div class="meta-consul mb-1 d-inline-block">
                                    <a href="#" title="Категория" class="text-decoration-none mb-3 me-2">
                                        <i class="fas fa-solid fa-list-check main-color" title="Постановления"></i>
                                        Самооценка на администрацията по действащи планове за действие
                                    </a>
                                </div>
                                <div class="status mt-1">
                                    <span>Статус: <span class="active-ks">Изпълнен</span></span>
                                </div>
                    ...
                    <div class="single-consultation d-flex">
                        ...
                        <div class="consult-body">
                            <div href="#" class="consul-item">
                                ...
                                <div class="meta-consul mb-1 d-inline-block">
                                    <a href="#" title="Категория" class="text-decoration-none mb-3 me-2">
                                        <i class="bi bi-person-fill-check fa-link main-color" title="Постановления"></i>
                                        Независим оценител по изпълнението на плана
                                    </a>
                                </div>
                                <div class="status mt-1">
                                    <span>Статус: <span class="active-ks">Изпълнен</span></span>
                    ...
                    <div class="single-consultation d-flex">
                        ...
                        <div class="consult-body">
                            <div href="#" class="consul-item">
                                ...
                                <div class="status mt-1">
                                    <span>Статус: <span class="inactive-ks">Незапочнало изпълнение</span></span>
                                </div>
                                <div class="meta-consul mt-2">
                                    <span class="text-secondary">
                                    <span class="text-dark"><i class="far fa-calendar text-secondary"></i> </span> 04.07.2023 г.- 05.09.2023г.
                    ...
                    <div class="single-consultation d-flex">
                        ...
                        <div class="consult-body">
                            <div href="#" class="consul-item">
                                ...
                                <div class="status mt-1">
                                    <span>Статус: <span class="closed-li">Oграничено изпълнение</span></span>
                                </div>
                                <div class="meta-consul mt-2">
                                    <span class="text-secondary">
                                    <span class="text-dark"><i class="far fa-calendar text-secondary"></i> </span> 04.07.2023 г.- 05.09.2023г.
