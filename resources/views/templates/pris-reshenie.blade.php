...
@section('pageTitle', 'Решение №752 на Министерския съвет от 2023 г.')
            ...
            <div class="row breadcrumbs py-1">
                <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="#">Решения</a></li>
                        <li class="breadcrumb-item"><a href="#">Решение №752 на Министерския съвет от 2023 г.</a></li>
                    </ol>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row edit-consultation m-0">
            <div class="col-md-12 text-end">
                <button class="btn btn-sm btn-primary main-color mt-2">
                    <i class="fas fa-pen me-2 main-color"></i>Редактиране на решение</button>
            </div>
        </div>
    </div>
                                        ...
                                        <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                                            ...
                                            <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1">
                                                <ul class="list-unstyled ps-3">
                                                    ...
                                                    <hr class="custom-hr">
                                                    <li class="my-2"><a href="#"
                                                            class="active-item-left p-1 text-white  text-decoration-none">Решения</a>
                                                    </li>
                                                    <hr class="custom-hr">
                                                    <li class="my-2"><a href="#"
            ...
            <div class="col-lg-10  right-side-content py-5">
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        <a href="#"><span class="pris-tag">Решение</span></a>
                    </div>
                </div>
                <div class="row pris-row pb-2 mb-2">
                    <div class="col-md-3 pris-left-column">
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        <!-- да бъде линк към страницата на консултацията с този номер -->
                        <a href="#" class="text-decoration-none">75204505</a>
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        ЗА ПРЕДЛОЖЕНИЕ ДО НАРОДНОТО СЪБРАНИЕ ЗА РАТИФИЦИРАНЕ НА СПОРАЗУМЕНИЕТО НА УЧАСТВАЩИТЕ СЪДРУЖНИЦИ КЪМ
                        ФОНДА НА НАТО ЗА ИНОВАЦИИ
                    </div>
                </div>
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        <!-- Новото поле „Вносител“ става линк към търсачката, с резултати филтрирани по този вносител  -->
                        <a href="#" class="text-decoration-none">МС </a>,<a href="#"
                            class="text-decoration-none">МО</a>
                    </div>
                </div>
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        <a href="#" class="text-decoration-none"> 91 от 2023г.</a>
                    </div>
                </div>
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        чл. 105, ал. 1 от Конституцията на Република България, чл. 15, ал. 1 от Закона за международните
                        договори на Република България и чл. 25 от Виенската конвенция за правото на договорите от 1969 г.
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column"><a href="#"><span class="pris-tag">
                                споразумения</span></a> <a href="#"><span class="pris-tag">НАТО</span></a> <a
                            href="#"><span class="pris-tag">иновации</span></a><span
                            class="pris-tag">фондове</span><a href="#"><span class="pris-tag">Фонд на НАТО за
                                иновации</span></a><a href="#"><span class="pris-tag">ратификации</span></a><a
                            href="#"><span class="pris-tag">М-во на иновациите и растежа</span></a>
                    </div>
                </div>
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        <a href="#" class="main-color"><a
                                ...
                                class="text-decoration-none">Постановление №961 на Министерския съвет от 2000 г.</a></a>
                    </div>
                </div>
                ...
                <div class="row pris-row pb-2 mb-2">
                    ...
                    <div class="col-md-9 pris-left-column">
                        <p class="mb-0">
                            <a href="#" class="text-decoration-none">12.05.2023г. от потребител Иван Иванов</a>
                        </p>
                        <p class="mb-0">
                            <a href="#" class="text-decoration-none">15.08.2023г. от потребител Иван Иванов</a>
                        </p>
                        <p class="mb-0">
                            <a href="#" class="text-decoration-none">17.09.2023г. от потребител Иван Иванов</a>
                        </p>
