        ...
        <div class="col-md-12">
          <div class="slider-content">
            <div class="breadcrumbs">
              <a href="#">Начало</a> » <a href="#">Решения</a>
            </div>
  ...
  <section class="public-page">
    <div class="container">
      ...
      <div class="row pris-row pb-2 mb-2">
        ...
        <div class="col-md-9 pris-left-column">
          ЗА ПРЕДЛОЖЕНИЕ ДО НАРОДНОТО СЪБРАНИЕ ЗА РАТИФИЦИРАНЕ НА СПОРАЗУМЕНИЕТО НА УЧАСТВАЩИТЕ СЪДРУЖНИЦИ КЪМ ФОНДА НА НАТО ЗА ИНОВАЦИИ
        </div>
      </div>
...
48.21
      ...
      <div class="row pris-row pb-2 mb-2">
        ...
        <div class="col-md-9 pris-left-column">
          чл. 105, ал. 1 от Конституцията на Република България, чл. 15, ал. 1 от Закона за международните договори на Република България и чл. 25 от Виенската конвенция за правото на договорите от 1969 г.
      ...
      <div class="row pris-row pb-2 mb-2">
        ...
        <div class="col-md-9 pris-left-column"><span class="pris-tag">
          споразумения</span> <span class="pris-tag">НАТО</span> <span class="pris-tag">иновации</span><span class="pris-tag">фондове</span><span class="pris-tag">Фонд на НАТО за иновации</span><span class="pris-tag">ратификации</span><span class="pris-tag">М-во на иновациите и растежа</span>
        </div>
      </div>
      ...
      <div class="row pris-row pb-2 mb-2">
        ...
        <div class="col-md-9 pris-left-column">
          <a href="#" class="main-color"><a href="{{ route('templates.view', ['slug' => 'pris-postanovlenie']) }}" target="_blank">виж Пост 496 от 2022</a></a>
        </div>
      </div>
