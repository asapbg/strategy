    ...
    <div class="col-lg-10 pt-5 pb-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <a href="#" class="main-color text-decoration-none fs-18">
                    <span class="inactive-ks fs-16 link-dark">Изпълнен</span>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-4 mb-4">
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-center align-middle table-inactive">
                      <thead class="align-middle fw-600 gray-out">
                        <tr>
                            <td>                             
                                №
                            </td>
