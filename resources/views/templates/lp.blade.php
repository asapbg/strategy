    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> Списък Законодателни програми</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label mr-2" for="from_date">От дата: </label>02-2023
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label mr-2" for="to_date">До дата: </label>07-2023
                                </div>
                            </div>
                            <div class="col-12 my-3">
                                <table class="table table-sm sm-text">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://strategy.asapbg.com/admin/download/1" target="_blank">
                                    ...
                                    <tr>
                                        ...
                                        <td>Становище</td>
                                        <td>
                                            <a href="https://strategy.asapbg.com/admin/download/2" target="_blank">
                                                <i class="fas fa-file-download text-info" title="Изтегли"></i>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <div class="col-12">
                                <table class="table table-sm table-responsive sm-text table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <tr class="bg-light">
                                        <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="11"><strong>Месец 02.2023</strong></td>
                                    </tr>
                                    <tr>
                                        <td>1</td>
                                        <td>сдфдс1</td>
                                    ...
                                    <tr class="bg-light">
                                        <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="11"><strong>Месец 03.2023</strong></td>
                                    </tr>
                                    <tr><td class="text-center" colspan="11">---</td></tr>
                                    <tr class="bg-light">
                                        <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="11"><strong>Месец 04.2023</strong></td>
                                    </tr>
                                    <tr><td class="text-center" colspan="11">---</td></tr>
                                    <tr class="bg-light">
                                        <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="11"><strong>Месец 05.2023</strong></td>
                                    </tr>
                                    <tr><td class="text-center" colspan="11">---</td></tr>
                                    <tr class="bg-light">
                                        <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="11"><strong>Месец 06.2023</strong></td>
                                    </tr>
                                    <tr><td class="text-center" colspan="11">---</td></tr>
                                    <tr class="bg-light">
                                        <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="11"><strong>Месец 07.2023</strong></td>
                                    </tr>
                                    <tr><td class="text-center" colspan="11">---</td></tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="col-12">
                                <a href="https://strategy.asapbg.com/admin/consultations/legislative_programs"
                                   class="btn btn-primary">Обратно</a>
                            </div>
                        </div>
