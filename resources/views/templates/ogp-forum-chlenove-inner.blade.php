...
<div class="row">
    ...
    <div class="col-lg-10 py-5 right-side-content">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="obj-title mb-4">Дискусионен форум за "Членове на Форума – контактна информация"</h2>
            </div>
        </div>
            ...
            <div class="col-md-8">
                ...
                <a href="#" class="text-decoration-none">
                    <span class="obj-icon-info me-2"><i class="bi bi-chat-dots me-1 dark-blue"
                            title="Сфера на действие"></i>Членове на Форума – контактна информация</span>
                </a>
            </div>
