    ...
    <div class="col-lg-2 side-menu pt-5 mt-1" style="background:#f5f9fd;">
                ...
                <li class="mb-1">
                  ...
                  <div class="collapse show mt-3" id="home-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                      <li class="mb-2 active-item-left p-1"><a href="#" class="link-dark text-decoration-none">Обществени консултации</a></li>
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Оценка на въздействието</a>
                        <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                          <ul class="list-unstyled ps-3">
                            <hr class="custom-hr mt-2">
                            <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Инструменти</a></li>
                            <hr class="custom-hr">
                            <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Образци и форми </a></li><hr class="custom-hr">
                            <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Библиотека </a></li><hr class="custom-hr">
                            <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Списък на изготвящи оценки по ЗНА </a></li><hr class="custom-hr">
                          </ul>
                        </ul></li>
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Актове на МС</a></li>
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Гражданско участие</a></li>
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Стратегически документи</a></li>
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Консултативни съвети</a></li>
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Библиотека</a></li>
                    </ul>
                  </div>
                </li>
                <hr class="custom-hr">
        ...
        <div class="side-menu-2 mt-4">
          <ul class="list-unstyled">
            <li class="mb-1">
              <a class="btn-toggle pe-auto align-items-center rounded ps-2 text-decoration-none cursor-pointer fs-5 dark-text fw-600" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="true">
                <i class="fa-solid fa-bars me-2 mb-2"></i>Начало (Меню ТИП 2)
              </a>
              <hr class="custom-hr">
              <div class="collapse show mt-3" id="home-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
        ...
        <div class="side-menu-2 mt-4">
          <ul class="list-unstyled">
            <li class="mb-1">
              <a class="btn-toggle pe-auto align-items-center rounded ps-2 text-decoration-none cursor-pointer fs-5 dark-text fw-600" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="true">
                <i class="fa-solid fa-bars me-2 mb-2"></i>Начало (Меню ТИП 3)
              </a>
              <hr class="custom-hr">
              <div class="collapse show mt-3" id="home-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                  <li class="mb-2 active-item-left p-1"><a href="#" class="link-dark text-decoration-none">Обществени консултации</a></li>
                  <ul class="list-unstyled ps-3">
                    <li class="my-2 active-item-left p-1"><a href="#" class="link-dark text-decoration-none">Подстраница Ниво 2 - Активна</a></li>
                    <hr class="custom-hr">
                    <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Подстраница Ниво 2</a></li>
                    <hr class="custom-hr">
                    <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Подстраница Ниво 2 </a></li><hr class="custom-hr">
                    <li class="my-2"><a href="#" class="link-dark  text-decoration-none">Подстраница Ниво 2 </a></li><hr class="custom-hr">
                  </ul>
                </ul>
              </div>
