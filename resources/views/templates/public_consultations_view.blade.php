...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-lg-2 side-menu mt-5">
                ...
                <li class="mb-1">
                  ...
                  <div class="collapse show mt-3" id="home-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal px-2 pb-1 small">
                      ...
                      <li class="mb-2"><a href="#" class="link-dark  text-decoration-none">Оценка на въздействието</a></li>
    ...
    <div class="col-lg-3">
      <div class="row mt-5">
        <div class="col-md-12">
          <div class="hori-timeline px-5" dir="ltr">
