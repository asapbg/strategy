...
<section class="public-constultation">
    <div class="container">
        <div class="row">
            <div class="col-lg-6  home-results home-results-two fix-one" >
            ...
            <div class="col-lg-6 home-results-two home-results fix-two">
        ...
        <div class="row">
            <div class="col-md-4 position-relative">
                <div class="service-item  position-relative">
                    ...
                    <p>В този раздел може да намерите всички постановления, разпореждания и решения, включително протоколните
                        решения.</p>
            ...
            <div class="col-md-4 position-relative">
                <div class="service-item  position-relative">
                    ...
                    <p>Основната цел на проекта е подобряване процеса по реализиране, мониторинг и оценка на хоризонталните
                        политики в България.</p>
                    <a href="#" class="readmore stretched-link">Вижте още <i class="fas fa-arrow-right read-more"></i></a>
                </div>
            </div>
