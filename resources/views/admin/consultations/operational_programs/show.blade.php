                            ...
                            <table class="table table-sm table-responsive sm-text  table-bordered table-hover">
                                ...
                                @if(isset($months) && sizeof($months))
                                    @foreach($months as $month)
                                        ...
                                        @php($hasData = 0)
                                        <tr class="bg-light">
                                            <td class="text-center" style="border-bottom:1px solid #333;border-top:1px solid #333;" colspan="{{ $fullColspan }}">{{ trans_choice('custom.months', 1) }} <strong>{{ $month }}</strong></td class="text-center">
                                        </tr>
                                        @if(isset($data) && $data)
                                        ...
                                        @endif
                                        @if(!$hasData)
                                            <tr class="text-center"><td colspan="{{ $fullColspan }}">---</td></tr>
                                        @endif
                                    @endforeach
                                @endif
                                </tbody>
