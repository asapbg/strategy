...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('custom.publications', 1) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            {{ trans_choice('custom.publications', 2) }}
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="" method="post" name="form" id="form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 control-label" for="highlighted_publication">
                                <input type="checkbox" id="highlighted_publication" name="highlighted_publication">
