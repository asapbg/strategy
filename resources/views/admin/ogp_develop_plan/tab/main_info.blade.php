            ...
            <div class="row mb-4">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <input type="text" id="from_date_develop" name="from_date_develop" class="form-control form-control-sm datepicker @error('from_date_develop'){{ 'is-invalid' }}@enderror" value="{{ old('from_date_develop', displayDate($item->from_date_develop) ?? '') }}" autocomplete="off">
                                <span class="input-group-text" id="basic-addon2"><i class="fas fa-solid fa-calendar"></i></span>
                            </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <input type="text" id="to_date_develop" name="to_date_develop" class="form-control form-control-sm datepicker @error('to_date_develop'){{ 'is-invalid' }}@enderror" value="{{ old('to_date_develop', displayDate($item->to_date_develop) ?? '') }}" autocomplete="off">
                                <span class="input-group-text" id="basic-addon2"><i class="fas fa-solid fa-calendar"></i></span>
                            </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <select id="ogp_status_id" name="ogp_status_id" class="form-control form-control-sm @error('ogp_status_id'){{ 'is-invalid' }}@enderror">
                                    <option></option>
