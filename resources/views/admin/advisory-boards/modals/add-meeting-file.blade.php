<div class="modal fade" id="modal-add-meeting-file" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" name="MEETING_FILE" enctype="multipart/form-data" class="pull-left mr-4">
                    @csrf
                        ...
                        @foreach(config('available_languages') as $lang)
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label for="" onclick="MEETING_FILE.querySelector('input[id=file_{{ $lang['code'] }}]').click()"
