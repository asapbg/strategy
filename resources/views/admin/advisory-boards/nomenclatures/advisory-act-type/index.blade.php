        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body table-responsive">
                    ...
                    <div class="mb-3">
                        @includeIf('partials.status', ['action' => 'App\Http\Controllers\Admin\Nomenclature\AdvisoryActTypeController@index'])
                        ...
                        @if(isset($items) && $items->count() > 0)
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('update', $item)
                                            @includeIf('partials.toggle-boolean', ['object' => $item, 'model' => 'AdvisoryActType'])
                                        @endcan
                                    </td>
