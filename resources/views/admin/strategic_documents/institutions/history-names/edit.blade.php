        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.strategic_documents.institutions.history-name.update', $institutionHistoryName->id) }}" method="post" name="form" id="form">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="name" name="name"
                                           ...
                                           value="{{ old('name', $institutionHistoryName->name) }}"
                                    >
                                    @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="valid_from" name="valid_from"
                                           ...
                                           value="{{ old('valid_from', displayDate($institutionHistoryName->valid_from)) }}"
                                    >
                                    @error('valid_from')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="valid_till" name="valid_till"
                                           ...
                                           value="{{ old('valid_till', displayDate($institutionHistoryName->valid_till)) }}"
                                    >
                                    @error('valid_till')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <a href="{{ route('admin.strategic_documents.institutions.edit', $institutionHistoryName->institution_id) }}" class="btn btn-primary">
                                    {{ __('custom.cancel') }}
                                </a>
                            </div>
                        </div>
