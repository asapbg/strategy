        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sd.users.store') }}" method="post" name="form" id="form">
                        @csrf
...
{{--                                </div>--}}
                                ...
                                <div class="form-group" id="institution_select">
                                    <label class="col-sm-12 control-label" for="email">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <a href="{{ route('admin.sd.users') }}" class="btn btn-primary">{{ __('custom.cancel') }}</a>
                            </div>
                        </div>
                        <br/>
                    </form>
