                ...
                <div class="card-body">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row mt-4">
                            ...
                            <form class="row sd-form-files" id="fileform_{{ $item->id }}" data-extension="{{ implode(',', \App\Models\File::ALLOWED_FILE_STRATEGIC_DOC) }}" data-size="{{ (config('filesystems.max_upload_file_size') * 1024) }}" action="{{ route('admin.upload.file.languages', ['object_id' => $item->id, 'object_type' => \App\Models\File::CODE_OBJ_STRATEGIC_DOCUMENT_CHILDREN]) }}" method="post" name="form" id="form" enctype="multipart/form-data">
                                @csrf
