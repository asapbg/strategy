                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="custom-tabsContent">
                        ...
                        <div class="tab-pane fade active show" id="ct-general" role="tabpanel" aria-labelledby="ct-general-tab">
                                        ...
                                        <div class="d-inline">
                                            <select id="type" name="type" onchange="changePublicationType(this)" class="form-control select2 form-control-sm @error('type'){{ 'is-invalid' }}@enderror">
                                                @foreach(optionsPublicationTypes() as $row)
                                                    @if($row['value'] == \App\Enums\PublicationTypesEnum::TYPE_OGP_NEWS->value)
                            ...
                            <div class="col-12" id="ogp_section">
{{--                                <div class="col-md-6 col-12">--}}
{{--                                    <div class="form-group">--}}
...
{{--                                        <div class="d-inline">--}}
{{--                                            @php--}}
{{--                                                $oldOgp = old('ogp', $item->id ? $item->ogp_id : 0) ? \App\Models\OgpPlan::with(['translation'])->where('id', old('ogp', $item->id ? $item->ogp_id : 0))->first() : null--}}
{{--                                            @endphp--}}
{{--                                            <select id="adv_board" name="adv_board"--}}
{{--                                                    class="form-control form-control-sm select2-autocomplete-ajax @error('ogp'){{ 'is-invalid' }}@enderror"--}}
{{--                                                    data-bymoderator="true" data-types2ajax="adv_board" data-urls2="{{ route('admin.select2.ajax', 'ogp') }}"--}}
{{--                                            >--}}
{{--                                                    @if($oldOgp)--}}
{{--                                                        <option value="{{ $oldOgp->id }}" selected >{{ $oldOgp->name }}</option>--}}
{{--                                                    @endif--}}
{{--                                                </select>--}}
{{--                                                @error('ogp')--}}
{{--                                                <div class="text-danger mt-1">{{ $message }}</div>--}}
...
{{--                                    </div>--}}
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <a href="{{ route($listRouteName, ['type' => \App\Enums\PublicationTypesEnum::TYPE_OGP_NEWS->value]) }}" class="btn btn-primary">{{ __('custom.cancel') }}</a>
                                </div>
                            </div>
