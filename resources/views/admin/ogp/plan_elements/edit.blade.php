...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('custom.ogp.plan_elements', 1) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            {{ trans_choice('custom.ogp.plan_elements', 2) }}
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="" method="post" name="form" id="form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 control-label">{{ trans_choice('validation.attributes.element_type', 1) }}<span class="required">*</span></label>
                            <div class="col-12">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 control-label">{{ trans_choice('validation.attributes.status', 1) }}<span class="required">*</span></label>
                            <div class="col-12">
                                <select class="form-control form-control-sm select2">
                                    <option>Изберете</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{ route('admin.ogp.estimations.index') }}"
                                    class="btn btn-warning">{{ trans_choice('custom.ogp.estimations', 2) }}</a>
                            </div>
                        </div>
