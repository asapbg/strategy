@component('mail::message')
    ...
    {{ trans_choice('strategic_document_level', 1) }}: {{ __('custom.strategic_document.dropdown.' . \App\Enums\InstitutionCategoryLevelEnum::keyByValue($modelInstance->strategic_document_level_id)) }}\
    {{ trans_choice('strategic_document_type', 1) }} : {{ $modelInstance->documentType?->name }}\
